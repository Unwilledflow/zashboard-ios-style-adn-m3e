...
const zhTW: LANG_MESSAGE = {
  ...
  addSourceIPLabel: '新增源IP標籤',
  deleteSourceIPLabel: '刪除源IP標籤',
  sourceIPLabelScope: '源IP標籤作用域',
  ...
  disconnectConnection: '斷開連接',
  blockConnection: '阻斷連接',
  backgroundOptions: '背景選項',
  groupByColumn: '按{name}分組',
  ungroupColumn: '取消{name}分組',
  pinColumn: '固定{name}',
  unpinColumn: '取消固定{name}',
  ...
  moreSettings: '更多設定',
  customIcon: '自訂圖示',
  addCustomIcon: '新增自訂圖示',
  editCustomIcon: '編輯自訂圖示',
  deleteCustomIcon: '刪除自訂圖示',
  ...
  resetShortcut: '重設{name}快捷鍵',
  editKeyboardShortcuts: '編輯快捷鍵',
  ...
  blurIntensity: '毛玻璃強度',
  lowPowerMode: '低功耗模式',
  lowPowerModeTip: '降低視覺效果、動畫和輪詢頻率以節省電量',
  ...
  groupTestUrls: '組測試連結',
  addGroupTestUrl: '新增組測試連結',
  editGroupTestUrls: '編輯組測試連結',
  deleteGroupTestUrl: '刪除組測試連結',
  groupTestUrlsTip:
  ...
  // Accessibility & ARIA
  mainNavigation: '主導航',
  skipToContent: '跳轉到主內容',
  backendSelector: '後端選擇器',
  testAllLatency: '測試全部延遲',
  ...
  downloadLogs: '下載日誌',
  noProxyGroups: '暫無代理組',
  noProxyGroupsDesc: '沒有可用的代理組，請檢查後端配置。',
  noLogs: '暫無日誌',
  noLogsDesc: '當流量經過代理時，日誌將顯示在此處。',
  noRules: '暫無規則',
  noRulesDesc: '當前後端未配置任何規則。',
  noConnections: '暫無活躍連線',
  noConnectionsDesc: '當流量開始傳輸時，活躍連線將顯示在此處。',
  noClosedConnections: '暫無已關閉連線',
  noClosedConnectionsDesc: '已關閉的連線將顯示在此處。',
  errorOccurred: '發生錯誤',
  retry: '重試',
  loading: '載入中',
