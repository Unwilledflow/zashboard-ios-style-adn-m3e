...
const zh: LANG_MESSAGE = {
  ...
  addSourceIPLabel: '添加源IP标签',
  deleteSourceIPLabel: '删除源IP标签',
  sourceIPLabelScope: '源IP标签作用域',
  ...
  groupByColumn: '按{name}分组',
  ungroupColumn: '取消{name}分组',
  pinColumn: '固定{name}',
  ...
  resetShortcut: '重置{name}快捷键',
  editKeyboardShortcuts: '编辑快捷键',
  ...
  blurIntensity: '毛玻璃强度',
  lowPowerMode: '低功耗模式',
  lowPowerModeTip: '降低视觉效果、动画和轮询频率以节省电量',
  ...
  groupTestUrls: '组测试链接',
  addGroupTestUrl: '添加组测试链接',
  editGroupTestUrls: '编辑组测试链接',
  deleteGroupTestUrl: '删除组测试链接',
  groupTestUrlsTip:
  ...
  downloadLogs: '下载日志',
  noProxyGroups: '暂无代理组',
  noProxyGroupsDesc: '没有可用的代理组，请检查后端配置。',
  noLogs: '暂无日志',
  noLogsDesc: '当流量经过代理时，日志将显示在此处。',
  noRules: '暂无规则',
  noRulesDesc: '当前后端未配置任何规则。',
  noConnections: '暂无活跃连接',
  noConnectionsDesc: '当流量开始传输时，活跃连接将显示在此处。',
  noClosedConnections: '暂无已关闭连接',
  noClosedConnectionsDesc: '已关闭的连接将显示在此处。',
  errorOccurred: '出现错误',
  retry: '重试',
  loading: '加载中',
